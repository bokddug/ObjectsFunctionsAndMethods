...
def try_methods_and_functions():
    ...
    hj =rg.SimpleTurtle()
    hj.pen =rg.Pen('blue',5)
    hj.forward(150)
    hj.speed = 1
    draw_many_squares(hj, 2, 100, 30)

    hj.speed = 5
    hj.pen =rg.Pen('red', 5)
    draw_many_squares(hj, 10, 50, 15)

    hj.speed = 100
    hj.pen =rg.Pen('red', 35)
    draw_many_squares(hj, 8, 300 ,60)

    hj.pen =rg.Pen('black', 3)
    hj.backward(200)
    hj.draw_circle(30)
    hj.draw_square(50)
